...
local set_groups = function()
    local highlights = {
        ...
        { hg = "DiffChange",                  fg = c.yellow,        gui = "underline",                      cterm =
        "underline" },                                                            -- diff mode: Changed line
        ...
        { hg = "MatchParen",                  fg = c.yellow,        gui = "underline",                      cterm =
        "underline" },                                                            -- The character under the cursor or just before it, if it is a paired bracket, and its match.
        ...
        { hg = "markdownItalic",              fg = c.fg,            bg = c.none,                            gui =
        "italic" },
